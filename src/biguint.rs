...
const BIG_DIGIT_BITS: usize = 64;
const DOUBLE_BIG_DIGIT_BITS: usize = 2 * BIG_DIGIT_BITS;
...
#[derive(Debug)]
pub struct DoubleBigUint<const N: usize> {
    low: BigUint<N>,
    high: BigUint<N>,
}
impl<const N: usize> DoubleBigUint<N> {
    fn zero() -> Self {
        Self {
            high: BigUint::<N>::zero(),
            low: BigUint::<N>::zero(),
